...
/**
 * @package GuidanceMenu
 * @desc Class to control the forum page creation
 * @author SiteSell, Inc.
 */
class GuidanceMenu extends BxpMenus {
	...
	{
		$this->load_template('guidance');
	}
	
}

/* End of Guidance.class.php */
/* Location: includes/lib/BxpMenus/Guidance.class.php */