(function() {
	...
	function doOpenVidQT(url, name, params) {
	...
	global.popvidqt = function(url, width, height) {
		var height = isSafari5 ? 480 : 540;
		doOpenVidQT(url, 'videos', {width: 856, height: height});
		return false;
	};
